...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Generator.force_generate'
        db.add_column(u'turngeneration_generator', 'force_generate',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Generator.force_generate'
        db.delete_column(u'turngeneration_generator', 'force_generate')
    ...
    models = {
        ...
        u'turngeneration.generationtime': {
            'Meta': {'ordering': "['-timestamp']", 'object_name': 'GenerationTime'},
            'generator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'timestamps'", 'to': u"orm['turngeneration.Generator']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'turngeneration.generator': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'force_generate': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'generating': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
