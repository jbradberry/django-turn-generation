...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Generator.generating'
        db.add_column(u'turngeneration_generator', 'generating',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Generator.generating'
        db.delete_column(u'turngeneration_generator', 'generating')
